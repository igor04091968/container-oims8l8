...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-oims8l8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-oims8l8.containers.anotherwebservice.com/
...
```
git clone git@github.com:igor04091968/container-oims8l8.git
cd container-oims8l8
```
...
```
docker attach container-oims8l8
```
